...
Achievements.DEFINITIONS = {
	...
	{
		id = "trillionaire",
		name = "Trillion Dollar Charter",
		description = "Earn $1,000,000,000,000 in funds",
		icon = "💎",
	...
	},
	{
		...
		description = "Earn $1,000,000,000,000,000 in funds",
		icon = "🏛️",
	...
	},
	{
		id = "senate_charter",
		name = "Senate Charter",
		description = "Launch 100 vehicles total",
		icon = "📜",
		target = 100,
		gemReward = 150,
		badgeId = 0,
	...
	{
		id = "galactic_engineer",
		name = "Galactic Engineer",
		description = "Launch 250 vehicles total",
		icon = "🛠️",
		target = 250,
		gemReward = 500,
		badgeId = 0,
	...
	},
	{
		...
		description = "Manually launch 100,000 missions",
		icon = "🌠",
		target = 100_000,
		gemReward = 1000,
		badgeId = 0,
